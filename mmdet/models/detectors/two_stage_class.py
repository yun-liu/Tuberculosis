...
class TwoStageCLSDetector(BaseDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(TwoStageCLSDetector, self).__init__(init_cfg)
        if pretrained:
    ...
    def simple_test(self, img, img_metas, proposals=None, rescale=False):
        ...
        return self.roi_head.simple_test(
            x, proposal_list, img_metas, rescale=rescale), img_cls_scores
