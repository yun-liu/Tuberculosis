...
def imshow_gt_det_bboxes_vis(img,
                         annotation,
                         result,
                         class_names=None,
                         score_thr=0,
                         gt_bbox_color=(0, 0, 255),
                         gt_text_color=(0, 0, 255),
                         gt_mask_color=(255, 102, 61),
                         det_bbox_color=(0, 255, 255),
                         det_text_color=(0, 255, 255),
